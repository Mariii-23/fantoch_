...
fn nfr_plot() -> Result<(), Report> {
    println!(">>>>>>>> NFR <<<<<<<<");
    let results_dir = "/home/mariana.d.rodriguesthesis_results/results_nfr";
    // fixed parameters
...
fn fast_path_plot() -> Result<(), Report> {
    println!(">>>>>>>> FAST PATH <<<<<<<<");
    //FIXMe:
    let results_dir = "/home/mariana.d.rodriguesola";
    // fixed parameters
...
fn increasing_sites_plot() -> Result<(), Report> {
    ...
    let results_dir =
        "/home/mariana.d.rodriguesthesis_results/results_increasing_sites";
    // fixed parameters
    let key_gen = KeyGen::ConflictPool {
        conflict_rate: 2,
        pool_size: 1,
...
fn fairness_plot() -> Result<(), Report> {
    ...
    //FIXME:
    let results_dir =
        "/home/mariana.d.rodrigueseurosys_results/results_fairness_and_tail_latency";
    // fixed parameters
    let key_gen = KeyGen::ConflictPool {
        conflict_rate: 2,
        pool_size: 1,
...
fn batching_plot() -> Result<(), Report> {
    println!(">>>>>>>> BATCHING <<<<<<<<");
    let results_dir = "/home/mariana.d.rodrigueseurosys_results/results_batching";
...
fn partial_replication_plot() -> Result<(), Report> {
    ...
    let results_dir =
        "/home/mariana.d.rodrigueseurosys_results/results_partial_replication";
    // fixed parameters
